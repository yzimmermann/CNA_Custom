...
if __name__ == "__main__":
    ...
    seed_directories = ['seed'+str(i) for i in range(20)]
    ...
    # process_seed_directories(seed_directories, directory_path, name="CiteSeer")
    # directory_path = "log_files/KK_experiment123001_node_classification_ds_CiteSeer_type_CitationFull_layers_8_Model_LayerType.GCNCONV/"
    # process_seed_directories(seed_directories, directory_path, name="CiteSeer")
    # directory_path = "log_files/KK_experiment123002_node_classification_ds_CiteSeer_type_CitationFull_layers_8_Model_LayerType.GCNCONV/"
    # process_seed_directories(seed_directories, directory_path, name="CiteSeer")
    directory_path = "log_files/KK_experiment123003_node_classification_ds_CiteSeer_type_CitationFull_layers_8_Model_LayerType.TRANSFORMERCONV/"
    process_seed_directories(seed_directories, directory_path, name="CiteSeer")
    directory_path = "log_files/KK_experiment123004_node_classification_ds_CiteSeer_type_CitationFull_layers_8_Model_LayerType.TRANSFORMERCONV/"
    process_seed_directories(seed_directories, directory_path, name="CiteSeer")
